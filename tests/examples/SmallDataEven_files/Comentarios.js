define(function(require) {
					...
					if(data.length) {
						for(var i in data) {
							...
							if(comentario.image == null) {
								...
								if( comentario.image.indexOf('no_img.jpg') !==-1){
								   comentario.image = '<img style="width:96px;height:auto" src="' + get_establecimiento_img() + '" />'; 
								}else{
	...
	function get_establecimiento_img(){
	   return $('.border-img-restaurante').children('img.round10').attr('src');
